...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        GradingComponent::create([
            'subject_type' => 'Applied', // Academic Track (STEM, ABM, HUMSS, GAS)
            'written_weight' => 0.35,
        ...
        GradingComponent::create([
            'subject_type' => 'Specialized', // Technical-Vocational-Livelihood & special tracks
            'written_weight' => 0.20,
        ...
        // ========================================
        // Official complete DepEd Transmutation Table mapping
        $transmutations = [
