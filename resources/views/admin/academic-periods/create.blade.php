...
@section('page_subtitle', 'Add a new academic period to a school year')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">New Academic Period</h2>
                <p class="mt-1 text-sm text-gray-600">Create a new semester or grading period for a school year.</p>
            </div>

            <form action="{{ route('admin.academic-periods.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
