...
@section('toolbar')
    <div class="flex items-center justify-between gap-4 w-full">
        ...
        <a href="{{ route('admin.announcements.create') }}" class="inline-flex items-center gap-2 bg-primary-600 hover:bg-primary-700 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition shadow-sm hover:shadow-md whitespace-nowrap">
