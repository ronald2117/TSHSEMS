...
@section('page_subtitle', 'Update subject information.')
        ...
        <form method="POST" action="{{ route('admin.subjects.update', $subject) }}" class="space-y-6">
            ...
            <div>
                ...
                <select name="type" id="type" required
                    ...
                    <option value="Applied" {{ old('type', $subject->type) === 'Applied' ? 'selected' : '' }}>Applied Track Subject</option>
                    <option value="Specialized" {{ old('type', $subject->type) === 'Specialized' ? 'selected' : '' }}>Specialized Subject</option>
                </select>
                @error('type')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-gray-700">
                        <p class="font-medium mb-1">Current Subject Info:</p>
                        <p>Created: {{ $subject->created_at->format('M d, Y') }}</p>
                ...
                <div class="flex">
                    ...
                    <div class="text-sm text-blue-700">
                        ...
                        <ul class="list-disc list-inside space-y-1">
                            <li><strong>Core:</strong> Required for all students (e.g., English, Math, Science)</li>
                            <li><strong>Applied:</strong> Track-specific subjects (e.g., Pre-Calculus for STEM)</li>
                            <li><strong>Specialized:</strong> Strand-specific subjects</li>
                        </ul>
                    </div>
                </div>
            </div>
