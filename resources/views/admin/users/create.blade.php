    ...
    <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-sm p-8">
        <form method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="password" name="password" id="password" required
                           class="cursor-pointer w-full px-4 py-2 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
            ...
            <div class="flex items-center justify-between pt-6 border-t border-gray-100">
                ...
                <button type="submit" class="cursor-pointer bg-primary-600 hover:bg-primary-700 text-white px-6 py-2 rounded-lg font-medium transition">
                    Create User
                </button>
            </div>
        </form>
