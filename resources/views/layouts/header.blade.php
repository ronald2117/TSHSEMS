        ...
        <div class="flex items-center space-x-2 lg:space-x-4">
            ...
            <div class="relative">
                ...
                <div id="userMenuDropdown" class="cursor-pointer absolute right-0 mt-2 w-48 sm:w-56 bg-white rounded-lg shadow-lg hidden z-20 border border-gray-100">
                    ...
                    <a href="@if(auth()->user()->isStudent()) {{ route('student.profile.index') }} @elseif(auth()->user()->isTeacher()) {{ route('teacher.profile.index') }} @else # @endif" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition">
