...
<body class="bg-gray-50 min-h-screen">
    <!-- Navigation -->
    <x-header active="privacy-policy" />
        ...
        <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-8 border border-green-100">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <a href="mailto:dpo@taysan.edu.ph" class="text-primary-600 hover:text-primary-700">dpo@taysan.edu.ph</a>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <a href="tel:+631234567890" class="text-primary-600 hover:text-primary-700">+63 123 456 7890</a>
                    </div>
                </div>
            ...
            <div class="mt-6 pt-6 border-t border-green-200">
                <p class="text-sm text-gray-600">
                    ...
                    National Privacy Commission at <a href="https://www.privacy.gov.ph" target="_blank" rel="noopener" class="text-primary-600 hover:text-primary-700">www.privacy.gov.ph</a>
                </p>
            </div>
        </div>
    </div>
