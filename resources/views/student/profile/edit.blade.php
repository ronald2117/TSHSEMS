    ...
    <form action="{{ route('student.profile.update') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm p-6 space-y-6">
        ...
        <div class="flex items-center gap-6">
            ...
            <div class="flex-1">
                ...
                <input type="file" name="avatar" accept="image/*" onchange="previewAvatar(event)" class="cursor-pointer w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-green-50 file:text-primary-700 hover:file:bg-green-100">
