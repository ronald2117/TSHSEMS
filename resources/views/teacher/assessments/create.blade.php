...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Create New Assessment</h1>
            ...
            <div class="mb-4">
                ...
                <select name="class_schedule_id" 
                    ...
                    @foreach ($classSchedules as $schedule)
                        <option value="{{ $schedule->id }}" {{ old('class_schedule_id', $classScheduleId) == $schedule->id ? 'selected' : '' }}>
