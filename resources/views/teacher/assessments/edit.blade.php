    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <form action="{{ route('teacher.assessments.update', $assessment) }}" method="POST">
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" 
                           ...
                           class="cursor-pointer rounded border-gray-300 text-primary-600 focus:ring-green-500">
            ...
            <div class="flex gap-4">
                <button type="submit" 
                        class="cursor-pointer px-6 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition">
                    Update Assessment
                </button>
                <a href="{{ route('teacher.assessments.index') }}" 
                   class="cursor-pointer px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">
                    Cancel
                </a>
            </div>
        </form>
