...
<div class="p-6">
    ...
    <!-- Quick Action -->
    <div class="mb-6">
        <a href="{{ route('teacher.attendance.create') }}" class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach($classSchedules as $schedule)
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition">
                            ...
                            <a href="{{ route('teacher.attendance.roster', $schedule) }}" class="block text-center bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg font-medium transition text-sm">
                                Take Attendance
                            </a>
                        </div>
                    @endforeach
