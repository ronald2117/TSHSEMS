...
<div class="p-6">
    ...
    <form action="{{ route('teacher.attendance.store') }}" method="POST">
        ...
        <input type="date" name="date" value="{{ date('Y-m-d') }}" class="mb-4 px-4 py-2 border border-gray-300 rounded-lg">
        ...
        <div class="bg-white rounded-xl shadow-sm">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    <button type="button" onclick="markAll('Present')" class="px-3 py-1 text-xs bg-green-100 text-green-700 rounded hover:bg-green-200 transition">
                        Mark All Present
                    </button>
                    <button type="button" onclick="markAll('Absent')" class="px-3 py-1 text-xs bg-red-100 text-red-700 rounded hover:bg-red-200 transition">
                        Mark All Absent
                    </button>
                </div>
            </div>
