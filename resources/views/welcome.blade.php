    ...
    <div class="bg-white py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                <!-- Feature 1 -->
                <div class="bg-white rounded-xl shadow-md p-8 hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                    <div class="flex items-center justify-center h-14 w-14 rounded-lg bg-green-600 text-white mb-6">
                ...
                <!-- Feature 2 -->
                <div class="bg-white rounded-xl shadow-md p-8 hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                    <div class="flex items-center justify-center h-14 w-14 rounded-lg bg-blue-600 text-white mb-6">
                        <svg class="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Feature 3 -->
                <div class="bg-white rounded-xl shadow-md p-8 hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                    <div class="flex items-center justify-center h-14 w-14 rounded-lg bg-purple-600 text-white mb-6">
                        <svg class="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
